...
namespace Kursova
{
    ...
    public class Enterprise
    {
        ...
        public Enterprise(string name, string rozryad, string address, string phone, string specialization, string timeWork, string daysWork, string poslygu, string formaVlasnosty)
        {
            this.Name = name;
